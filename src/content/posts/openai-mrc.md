...
slug: openai-mrc
description: "A close reading of OpenAI/Microsoft/AMD/Broadcom/NVIDIA's MRC + SRv6 paper and the OCP MRC 1.0 specification, viewed from the UCCL-Tran perspective: a real step forward over switch-based adaptive routing, but with constraints that validate why a software-extensible transport still matters."
category:
  - One
tags:
  - MRC
